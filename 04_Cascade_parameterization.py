...
#------------------------------------------------------------------------------  
    ...
    elif Rule == 'Proposed approach' :
        for args_count in args:
            amnt_args = amnt_args+1
        if amnt_args == 3 :
            
            print('Using the Proposed approach allocation for 1st LCI only, the following parameters have been applied to '
            ...
            print('Wrong amount of arguments was used. To use the Proposed approach method for the 1st LCI, please enter 6 arguments with the following synthax :\n',
...
#------------------------------------------------------------------------------  
    ...
    elif Rule == 'Proposed approach VL' :
        for args_count in args:
            amnt_args = amnt_args+1
        if amnt_args == 1 :
            ...
            # Introductory message :
                ...
                print('Using the Proposed approach VL allocation, the following parameters have to be defined iteratively : \n'
            ...
            print('Wrong amount of arguments used. To use the Proposed approach VL method , please enter '
...
#------------------------------------------------------------------------------
       ...
       print('Invalid input. Pick one of the following allocation rule as string inputs : "Cut off", "Open loop S2017" , "Proposed approach" '
             ' , "Open loop VL S2017" or "Proposed approach VL". Alternatively,'
