...
fpCSV = r'C:\Users\User\Brightway2\Spyder files\Inventory_model.csv' #make sure to reach the right filepath in your own comp.
mydb = pd.read_csv(fpCSV, header = 0, sep = ",") # if using csv file
mydb['Exchange uncertainty type'] = mydb['Exchange uncertainty type'].fillna(0).astype(int)
...
Partitioning_method_B = 'Proposed approach'
Partitioning_method_F = 'Open loop S2017'
Partitioning_method_G = 'Proposed approach VL'
